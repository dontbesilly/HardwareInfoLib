...
namespace hardware_info
{
    public class ProcessorInfo<T> : BaseSmbiosInfo<T> where T : struct
    {
        ...
        base(data, stringsList, new List<string> { "socket_designation", "processor_manufacturer", "processor_version", "serial_number", "asset_tag", "part_number" })
        { }
    }
    ...
    public struct ProcessorStruct_30
    {
        ...
        [FieldOffset(0x07)]
        public byte processor_manufacturer;

        [FieldOffset(0x08)]
        public Guid processor_id;

        [FieldOffset(0x10)]
        public byte processor_version;
        ...
        [FieldOffset(0x23)]
        public byte core_count;

        [FieldOffset(0x24)]
        public byte core_enabled;
        ...
        [FieldOffset(0x28)]
        public short processor_family_2;

        // 3.0

        [FieldOffset(0x2A)]
        public short core_count_2;

        [FieldOffset(0x2C)]
        public short core_enabled_2;

        [FieldOffset(0x2E)]
        public short thread_count_2;
    }
