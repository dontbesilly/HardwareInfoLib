...
{
    [FieldOffset(0x06)] public byte major;

    [FieldOffset(0x07)] public byte minor;
}

[StructLayout(LayoutKind.Explicit, Size = 16, Pack = 1)]
public struct EntryPointStructure64
{
    [FieldOffset(0x07)] public byte major;

    [FieldOffset(0x08)] public byte minor;
}

[StructLayout(LayoutKind.Explicit, Size = 8, Pack = 1)]
public struct RawSMBIOSData
{
    [FieldOffset(0x01)] public byte major;

    [FieldOffset(0x02)] public byte minor;
}